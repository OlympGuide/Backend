...
namespace OlympGuide.Infrastructre.Migrations
{
    ...
    [Migration("20240516092153_SportFieldInReservation")]
    partial class SportFieldInReservation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OlympGuide.Domain.Features.Reservation.ReservationType", b =>
                {
                    ...
                    b.HasIndex("SportFieldId")
                        .HasDatabaseName("ix_reservations_sport_field_id");
            ...
            modelBuilder.Entity("OlympGuide.Domain.Features.Reservation.ReservationType", b =>
                {
                    b.HasOne("OlympGuide.Domain.Features.SportField.SportFieldType", "SportField")
                        .WithMany()
                        .HasForeignKey("SportFieldId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_reservations_sport_fields_sport_field_id");
